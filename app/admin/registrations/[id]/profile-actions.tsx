    ...
    <div>
      <div className="flex flex-col gap-3 sm:flex-row">
        ...
        <button
          ...
          disabled={Boolean(loading)}
          className="rounded-full bg-navy-950 px-5 py-3 text-sm font-bold text-white disabled:opacity-60"
        >
        ...
        <button
          ...
          disabled={Boolean(loading)}
          className="rounded-full border border-slate-300 bg-white px-5 py-3 text-sm font-bold text-navy-950 disabled:opacity-60"
        >
